...
public class FixPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public FixPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public FixPagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            if (pager.getAdapter().getCount() != tabsContainer.getChildCount()) {
                notifyDataSetChanged();
            }
